    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Gerência de Con_livro_usuario            <small>cadastro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="{CAMINHO}index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="index.php">Con_livro_usuario</a></li>
        ...
        <section class="content">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Dados da Con_livro_usuario</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
          ...
          <div class="form-group col-xs-3">
            ...
            <select class="form-control select2" id="id_pedido" name="id_pedido" style="width: 100%;" required>
                <option value="0">-SELECIONE-</option>
                <!-- BEGIN PEDIDO_BLOCK -->
                <option value="{PEDIDO_ID}" {SELECTED_PEDIDO} >{PEDIDO}</option>
                <!-- END PEDIDO_BLOCK-->
            </select>
          </div>
            ...
            <div class="form-group col-xs-3">
              ...
              <input type="text" class="form-control" id="dt_alt" name="dt_alt" placeholder="Dt_alt" value="{DT_ALT}" required>
                  ...
                  <div class="box-footer">
                    ...
                    <input type="hidden" id="fId" name="fId" value="{IDCON_LIVRO_USUARIO}" >
