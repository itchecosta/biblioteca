...
class Con_livro_usuario{

  function Con_livro_usuario($id, $id_pedido, $id_usuario, $id_livro, $status, $dt_cadastro, $dt_alt, $ativo){
   $this->id = $id;
  ...
  function setAll($id_pedido = false, $id_usuario = false, $id_livro = false, $status = false, $dt_cadastro = false, $dt_alt = false, $ativo = false){
    if($id_pedido !== false)
  ...
  function getId_pedido(){ return $this->id_pedido;}
  ...
  function setId_pedido($x){ $this->id_pedido = $x;}
